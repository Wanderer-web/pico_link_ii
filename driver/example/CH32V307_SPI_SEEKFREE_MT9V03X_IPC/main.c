...
int main (void)
{
    ...
    // 此处编写用户代码 例如外设初始化代码等
    mt9v03x_init();                                                                                    // 初始化摄像头
    spi_init(SPI_3, SPI_MODE3, 10000000, SPI3_MAP0_SCK_B3, SPI3_MAP0_MOSI_B5, SPI3_MAP0_MISO_B4, C10); // 初始化SPI，波特率10000000，模式3
    // 此处编写用户代码 例如外设初始化代码等
    ...
    while(1)
    {
        ...
        {
            Compressimage();                                 // 压缩图像
            ipcSendImg_Spi((pico_uint8 *)Image_Use, 60, 80); // 发送图像
